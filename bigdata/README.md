...
```
cd existing_repo
git remote add origin https://collaborating.tuhh.de/e-19/teaching/bd25_project_f8_a.git
git branch -M main
...
- [ ] [Set up project integrations](https://collaborating.tuhh.de/e-19/teaching/bd25_project_f8_a/-/settings/integrations)
